...
SECRET_KEY = "django-insecure-8nlw-4=uz8xd=ma+qnxrrq2#3pkot#82jrx#n(z4gr^@m%0w1q"
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.BasicAuthentication',  # Use Basic Authentication globally
    ],
